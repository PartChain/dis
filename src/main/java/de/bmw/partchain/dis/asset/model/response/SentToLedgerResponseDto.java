...
public class SentToLedgerResponseDto
{
    ...
    public final void addFailedAsset(int index,
                                     String jsonRequestAsset,
                                     AssetFailType failType,
                                     List<String> failReasons,
                                     Set<String> warnings)
    {

        failedAssets.add(new AssetFailedReportResponseDto(index, failType, failReasons, new ArrayList<>(warnings), jsonRequestAsset));
    }
    ...
    public final void addFailedAsset(int index,
                                     ...
                                     List<String> failReasons)
    {
        failedAssets.add(new AssetFailedReportResponseDto(index, failType, failReasons, jsonRequestAsset));
    }
